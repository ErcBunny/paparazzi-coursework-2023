...
obstacle = np.random.permutation(read_img("E:/svm_test/AE4317_2019_datasets/cyberzoo_poles/0"))
empty = np.random.permutation(read_img("E:/svm_test/AE4317_2019_datasets/cyberzoo_poles/1"))
